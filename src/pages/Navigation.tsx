            ...
            <div className="subscribe-contacts">
              ...
              <div className="flex gap-7">
                <div className="sub-contact">
                  <svg className="contact-img" viewBox="0 0 38 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="sub-contact">
                  <svg className="contact-img" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="sub-contact">
                  <svg className="contact-img" viewBox="0 0 47 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="sub-contact">
                  <svg className="contact-img" viewBox="0 0 14 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="sub-contact">
                  <svg className="contact-img" viewBox="0 0 37 30" fill="none" xmlns="http://www.w3.org/2000/svg">
