    ...
    <>
      {data.map((el: any, ind: number) => {
        ...
        if (Math.floor((el.index - 1) / 2) % 2 === 0 && el.index <= n) {
          ...
          left =
            el.index % 2 !== 0
              ? 133 + 86 * Math.floor((el.index - n) / 2)
              : 169 + 86 * ((el.index - n) / 2 - 1);
          top = 110;
        }
...
function SeatTemplate() {
  ...
  return (
    <>
      <div className="h-[200px] left-[16px] w-[948px]">
        <div
          className={`absolute top-0 left-0 w-[948px] h-[200px] bg-[url('../../vecs/bg-seat.svg')]`}
        ></div>
        ...
        {data.map((el: any, ind: number) => {
          ...
          if (el.index <= lineBreakIndex) {
            if (cell === 0) {
              left = 133 + 93 * Math.floor(relativeIndex / 4);
            } else {
              left = 169 + 93 * Math.floor(relativeIndex / 4);
            }
          } else {
            if (cell === 0) {
              left = 133 + 93 * Math.floor(relativeIndex / 4);
        ...
        <div className="absolute top-[14px] left-[875px] w-[24px] h-[24px]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="absolute top-[165px] left-[86px] w-[24px] h-[24px]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <div className="absolute top-[165px] left-[875px] w-[24px] h-[24px]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div className="max-w-[948px]">
        <div className="max-h-[200px]">
          ...
          {/* <div className="h-[200px] left-[16px] w-[948px]">
            ...
            <div className="absolute top-[px] left-[86px] w-[24px] h-[24px]">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div className="absolute top-[150px] left-[910px] w-[24px] h-[24px]">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
