...
function LuxuryTemplate({ seatsData }: TemplateInterface) {
  ...
  return (
    <div className="h-[148px] w-[948px]">
      ...
      {seatsData.map((el: any, ind: number) => {
        const left =
          el.index % 2 !== 0
...
function KypeTemplate({ seatsData }: TemplateInterface) {
...
function PlazCartTemplate({ seatsData }: TemplateInterface) {
  ...
  return (
    <>
      <div className="h-[160px] w-[948px]">
        <div
          className={`absolute top-0 left-0 w-[948px] h-[160px] bg-[url('../../vecs/bg-plazc.svg')]`}
        ></div>
...
function SeatTemplate({ seatsData }: TemplateInterface) {
...
export default function Seats({ data }: SeatsProps) {
  //console.log(data.coach.class_type);

  let template;
  switch (data.coach.class_type) {
    case 'first':
      template = <LuxuryTemplate seatsData={data.seats} />
      break;
    case 'second':
      template = <KypeTemplate seatsData={data.seats} />
      break;
    case 'third':
      template = <PlazCartTemplate seatsData={data.seats} />
      break;
    case 'fourth':
      template = <SeatTemplate seatsData={data.seats} />
      break;
  ...
  return (
    <div className="">
      <div className="max-w-[948px] relative overflow-x-scroll ">
        <div className="max-h-[200px]">
          {/* <SeatTemplate seatsData={data.seats} /> */}
          {/* <LuxuryTemplate seatsData={data.seats} /> */}
          {/* <KypeTemplate seatsData={data.seats} /> */}
          {/* <PlazCartTemplate seatsData={data.seats} /> */}
