...
export default function TrainOptions() {
  ...
  const mainData = useSelector((state: RootState) => state.main.filters);
  ...
  return (
    <>
      {
        !isFetching && data ? data.map((option: any) => {
            ...
            <div className="flex gap-[2px] mb-[20px]">
              <div className="flex w-1/4 bg-[#F7F6F6] justify-center items-center gap-4">
                ...
                <div className="flex flex-col text-[14px] py-3">
                  <p className="text-[20px] font-semibold">{option.coach.name}</p>
                ...
                <div className="w-full grid grid-cols-3">
                  <div className="flex flex-col">
                    <div className="flex gap-2 text-[13px]">
                      <p className="text-[#928F94]">Места</p> {option.coach.available_seats}
                    </div>
